    ...
    return (
        <div className="w-full flex h-[85vh]">
            <div className="w-1/2 lg:px-4 lg:pt-4 xl:pl-8 x:pr-4 xl:pt-20 relative hidden lg:block">
                ...
                <h3 className="lg:text-[22px] xl:text-[24px] pt-5 leading-6">We are distributing | <span className="text-[#0d6db7]">Cooked Food</span></h3>
                ...
                <div className="absolute flex bottom-0 right-[48px] xl:pb-9">
                    <BsArrowLeft className="lg:text-6xl xl:text-6xl cursor-pointer" onClick={() => sliderRef.current.slickPrev()} />
                    <BsArrowRight className="lg:text-7xl xl:text-8xl cursor-pointer" onClick={() => sliderRef.current.slickNext()} />
                </div>
            </div>
